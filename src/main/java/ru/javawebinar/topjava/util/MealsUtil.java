...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(2, LocalDateTime.of(2015, Month.JUNE, 1, 10, 0), "Завтрак", 600),
            new Meal(2, LocalDateTime.of(2015, Month.JUNE, 1, 13, 0), "Обед", 1000),
            new Meal(2, LocalDateTime.of(2015, Month.JUNE, 1, 20, 0), "Ужин", 500),
            new Meal(2, LocalDateTime.of(2015, Month.JUNE, 2, 10, 0), "Завтрак", 1000),
            new Meal(2, LocalDateTime.of(2015, Month.JUNE, 2, 13, 0), "Обед", 500),
            new Meal(2, LocalDateTime.of(2015, Month.JUNE, 2, 20, 0), "Ужин", 400)
    );
